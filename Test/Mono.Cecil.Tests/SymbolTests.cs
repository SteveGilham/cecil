...
namespace Mono.Cecil.Tests {
		...
		public class SymbolTests : BaseTestFixture {
				...
				public void Embeds ()
				{
						using (var a = AssemblyDefinition.ReadAssembly (@"C:\Users\steve\Documents\GitHub\altcover\Samples\Sample28\GeneratedDemo\bin\Debug\netcoreapp3.1\CSharpGeneratedDemo.dll",
